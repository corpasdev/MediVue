...
<template>
  <Picture class="hero">
    <h1>Login</h1>
    <nav class="nav"><a href="http://">Home</a><span>></span><a href="http://">Login</a></nav>
  </Picture>
  ...
  <main class="container-login">
    <article class="login">
      ...
      <div class="wrappaper">
        <form action="" class="form-login" @submit.prevent="doLogin">
          <h3>Login Here</h3>
          <p>Didn't you account yet ? <a href="#" class="lost-pass">Register Here</a></p>
